...
export default function Seo() {
  ...
  return (
    <Helmet>
      ...
      <link rel="canonical" href={`https://florin-chelaru.github.io/twinfog/?hl=${localeManager.locale}`} />
      <meta name="description" content={componentStrings.description} />
      <meta property="og:title" content={componentStrings.title} />
      <meta property="og:url" content={`https://florin-chelaru.github.io/twinfog/?hl=${localeManager.locale}`} />
